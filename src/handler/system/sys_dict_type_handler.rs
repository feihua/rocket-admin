 ...
 */
#[post("/system/dictType/addDictType", data = "<item>")]
pub async fn add_sys_dict_type(item: Json<AddDictTypeReq>, _auth: Token) -> Value {
 ...
 *date：2025/01/09 16:16:41
 */
#[post("/system/dictType/deleteDictType", data = "<item>")]
pub async fn delete_sys_dict_type(item: Json<DeleteDictTypeReq>, _auth: Token) -> Value {
 ...
 *date：2025/01/09 16:16:41
 */
#[post("/system/dictType/updateDictType", data = "<item>")]
pub async fn update_sys_dict_type(item: Json<UpdateDictTypeReq>, _auth: Token) -> Value {
 ...
 *date：2025/01/09 16:16:41
 */
#[post("/system/dictType/updateDictTypeStatus", data = "<item>")]
pub async fn update_sys_dict_type_status(item: Json<UpdateDictTypeStatusReq>, _auth: Token) -> Value {
 ...
 *date：2025/01/09 16:16:41
 */
#[post("/system/dictType/queryDictTypeDetail", data = "<item>")]
pub async fn query_sys_dict_type_detail(item: Json<QueryDictTypeDetailReq>, _auth: Token) -> Value {
 ...
 *date：2025/01/09 16:16:41
 */
#[post("/system/dictType/queryDictTypeList", data = "<item>")]
pub async fn query_sys_dict_type_list(item: Json<QueryDictTypeListReq>, _auth: Token) -> Value {

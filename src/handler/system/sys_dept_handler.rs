...
pub async fn add_sys_dept(item: Json<AddDeptReq>, _auth: Token) -> Value {
...
pub async fn delete_sys_dept(item: Json<DeleteDeptReq>, _auth: Token) -> Value {
    ...
    let res1 = check_dept_exist_user(rb, &req.id)
        .await
        .unwrap_or_default();
    if res1 > 0 {
...
pub async fn update_sys_dept(item: Json<UpdateDeptReq>, _auth: Token) -> Value {
...
pub async fn update_sys_dept_status(item: Json<UpdateDeptStatusReq>, _auth: Token) -> Value {
...
pub async fn query_sys_dept_detail(item: Json<QueryDeptDetailReq>, _auth: Token) -> Value {
    ...
    match result {
        ...
        Err(err) => {
            BaseResponse::<QueryDeptDetailResp>::err_result_data(QueryDeptDetailResp::new(), err.to_string())
        }
    }
}
...
pub async fn query_sys_dept_list(item: Json<QueryDeptListReq>, _auth: Token) -> Value {
